...
clicks = 0;
    ...
    constructor(coords, distance, duration) {
        ...
        this.duration = duration; // in minutes3
...
class App {
    ...
    _loadMap(position) {
            ...
            console.log(`https://www.google.es/maps/@${latitude},${longitude},15z?hl=es`) ;
...
//if(!Number.isFinite(distance) || !Number.isFinite(duration) || !Number.isFinite(cadance)) return alert ('Inputs have to be positive numbers')
        ...
        /// if working running, create a running object
        if (type === 'running') {
    const cadance = +inputCadence.value;

            if(
    !validInput(distance, duration, cadance)  || !allPositive(distance, duration, cadance))
